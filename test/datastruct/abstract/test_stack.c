...
/* static void assert_stack(Stack *stack, int values[], int values_len); */
...
{
    /* TEST_ASSERT_EQUAL(-1, stack_peek(stack)); ERROR */
...
/* static void assert_stack(Stack *stack, int values[], int values_len) */
/* { */
/*     TEST_ASSERT_EQUAL(values_len, stack_length(stack)); */
/*     for (int i = 0; stack != NULL; i++) { */
/*         TEST_ASSERT_EQUAL(values[i], stack->value); */
/*         stack = stack->next; */
/*     } */
/* } */
